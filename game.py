...
class Game:
    ...
    #      Method: mainLoop
    #
    # Description: The game's main loop. Manages game speed, 'QUIT' events, and
    #              keyboard input (if the escape key has been pressed, this will
    #              be treated as a 'QUIT' event). Calls the 'gameLogic' and
    #              'draw' methods, then updates the display.
    #
    #      Inputs: None.
    #
    #     Outputs: None.
